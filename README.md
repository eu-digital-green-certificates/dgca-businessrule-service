...
This repository contains the source code of the Digital COVID Business Rule Service.

The DCC Business Rule Service is part of the national backends and caches the business rules, country list and value sets, that are distributed through the [DGCG](https://github.com/eu-digital-green-certificates/dgc-gateway). It is accessed by the DGC Verifier Apps ([Android](https://github.com/eu-digital-green-certificates/dgca-verifier-app-android), [iOS](https://github.com/eu-digital-green-certificates/dgca-verifier-app-ios)) to update the rules and value sets for certificate verification periodically.
